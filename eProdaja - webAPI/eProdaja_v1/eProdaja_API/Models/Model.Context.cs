...
namespace eProdaja_API.Models
{
    ...
    public partial class eProdajaEntities : DbContext
    {
        ...
        public virtual int esp_KorisniciUloge_Delete(Nullable<int> korisnikUlogaID)
        {
            var korisnikUlogaIDParameter = korisnikUlogaID.HasValue ?
                new ObjectParameter("KorisnikUlogaID", korisnikUlogaID) :
                new ObjectParameter("KorisnikUlogaID", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("esp_KorisniciUloge_Delete", korisnikUlogaIDParameter);
        }
